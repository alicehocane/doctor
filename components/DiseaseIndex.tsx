      ...
      <div className="space-y-3">
        {filteredDiseases.map((disease) => (
          <button
            ...
            className="w-full bg-white apple-shadow rounded-[1.2rem] p-4 flex items-center justify-between group active:scale-[0.99] transition-all border border-transparent hover:border-blue-50 text-left"
          >
